        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              {isGoogleLoading ? 'Google ilə bağlanır...' : 'Google ilə daxil ol'}
            </Button>
          ...
          <div className="text-center">
            <span className="text-sm text-gray-600">Hesabınız yoxdur? </span>
            <Link to={getRegisterLink()} className="text-sm text-red-500 hover:text-red-600 font-medium hover:underline transition-colors">
              Qeydiyyatdan keç
            </Link>
          </div>
        </CardContent>
